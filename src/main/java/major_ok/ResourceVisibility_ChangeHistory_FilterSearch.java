 ...
 */
public class ResourceVisibility_ChangeHistory_FilterSearch extends TestBase {
    /** check getting data from location filter.  ID:TRP_R&V_ChangeHistory_FilterSearch_01*/
    @Test
    public void checkgetdataby_locationfilter () throws Exception {
    ...
    @Test
    public void checkgetdataby_resourcefilter () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "Change History");
    ...
    @Test
    public void checkgetdataby_calendarfilter () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "Change History");
    ...
    /* not done */
    @Test
    public void Table_view_sort_filter () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "Change History");
