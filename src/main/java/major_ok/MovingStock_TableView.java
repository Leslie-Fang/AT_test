...
/**
 * Created by I331490 on 6/27/2016.
 */
public class MovingStock_TableView extends TestBase {

    /** check  overview.  ID:TRP_RAIL_R&V_MovingStock_TablewView_VehicleResources_01*/
    @Test
    public void check_overview () throws Exception {
    ...
    @Test
    public void check_LR_filter () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    @Test
    public void check_filter_by () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    @Test
    public void check_facet_filter () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    @Test
    public void check_Column_Setting_Button () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    public void Check_Planned_Stops_display () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    public void Check_stock_hyperlink_display () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    public void LoadAndDischarg_Overview () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
...
*/
    ...
    @Test
    /**/
    public void check_LR_filter_for_LoadAndDischarg () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    @Test
    /*No */
    public void check_facet_filter_LoadAndDischarge () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
    ...
    public void Freight_Order_hyperlink_LoadAndDischarge () throws Exception {
        UserLogon.withAdmin(driver);
        NavigateAction.NavigateToRailCar(driver);
        NavigateAction.NavigateToTab(driver, "RESOURCE VISIBILITY");
        NavigateAction.NavigateToSubtab(driver, "RESOURCE VISIBILITY", "MOVING STOCK");
